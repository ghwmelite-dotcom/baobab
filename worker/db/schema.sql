-- Cumulative D1 schema for Baobab — reference only, not applied directly.
-- Migrations in db/migrations/ are the source of truth; this file mirrors
-- their union for human reference and IDE tooling.
